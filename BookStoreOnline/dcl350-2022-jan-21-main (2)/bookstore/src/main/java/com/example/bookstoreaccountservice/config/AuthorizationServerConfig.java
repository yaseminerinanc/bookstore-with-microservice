...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
  ...
  public JwtAccessTokenConverter jwtAccessTokenConverter() {
	...
	public DefaultOAuth2AccessToken enhance(DefaultOAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        accessToken = (DefaultOAuth2AccessToken) super.enhance(accessToken, authentication);
